...
public class IconTest {
	...
	private void initialize() {
		...
		System.out.println(getClass().getResource("/com/kosmo/gui/java/img/공유1.png").toString());
				
		ImageIcon defaultIcon = new ImageIcon(IconTest.class.getResource("/com/kosmo/gui/java/img/공유1.png"));
...
//				String filename = "C:\\jp/workspace_java\\java_prj\\bin\\com\\kosmo\\gui\\demo\\aaa.jpg";
				String filename= getClass().getResource("/com/kosmo/gui/java/img/공유1.png").toString();
