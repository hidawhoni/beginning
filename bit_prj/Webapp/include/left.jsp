        ...
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-user">
            <div class="sidebar-user-picture">
              <img alt="세션이름" src="/img/avatar/이안 소머헐더.jpg">
            </div>
            <div class="sidebar-user-details">
             ...
             <c:if test="${sessionScope.SESS_GUBUN =='a'}"> (관리자)</c:if>
             <c:if test="${sessionScope.SESS_GUBUN =='u'}"> (사용자)</c:if>
             <c:if test="${sessionScope.SESS_GUBUN ==null}"> (게스트)</c:if> 
            
      <%--           
                ${sessionScope.SESS_GUBUN};
                ${sessionScope.SESS_NAME};
                ${requsetScope.REQ_PNT}; --%>
