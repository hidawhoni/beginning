	    ...
	    navigator.geolocation.getCurrentPosition(
	    		...
	    		function(position) {
	    			...
	    			<c:forEach var="vv" items="${SHOP_LIST}">
	    			   ...
	    			   // var ourCoords = { latitude : 37.5666263,longitude : 126.9783924};//json
	    		      ...
	    		      alert(mylat + ' ' + mylng + " "+distance); //function
	    		    ...
	    		    {
	    		      enableHighAccuracy: false,//정확도
	    		      maximumAge: 0,
	    		      timeout: Infinity//언제까지 기다릴래 
	    		      //속성옵션
	    		    }
