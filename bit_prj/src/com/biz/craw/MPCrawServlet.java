...
@WebServlet("/mango")
public class MPCrawServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	//http://localhost:8088/mango
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.setContentType("text/html; charset=UTF-8");
		MPCraw soup = new MPCraw();
		...
		ArrayList<MPVO> list = soup.mangoCrawling(url, selector, -1);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MPVO> list = soup.mangoCrawling(url, selector, topn);
		System.out.println(list.size() + "건 크롤링");
